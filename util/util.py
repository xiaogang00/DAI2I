...
def center_crop(img, target_size, bias=(0,0)):
    ...
    w = img.shape[1]
    if h < target_size[1]:
        pad1 = (target_size[1] - h) / 2
        pad2 = target_size[1] - h - pad1
        img = np.pad(img, ((pad1, pad2), (0, 0), (0, 0)), 'constant', constant_values=255)

    if w < target_size[0]:
        pad1 = (target_size[0] - w) / 2
        pad2 = target_size[0] - w - pad1
        img = np.pad(img, ((0, 0), (pad1, pad2), (0, 0)), 'constant', constant_values=255)
